  ...
  <div class="sidebar-brand">
    ...
    <ul class="sidebar-menu">
      ...
      <?php if ($_SESSION['status'] == "Admin") : ?>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Kelola User</span></a>
        ...
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Alternatif</span></a>
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="../s_alternatif/index.php">List Alternatif</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Kriteria</span></a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Matriks</span></a>
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="../s_matriks/index.php">Matriks</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Hasil</span></a>
          <ul class="dropdown-menu">
      ...
      <?php if ($_SESSION['status'] == "PJMapres") : ?>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Validasi Mapres</span></a>
          <ul class="dropdown-menu">
      ...
      <?php if ($_SESSION['status'] == "Mahasiswa") : ?>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-circle"></i> <span>Nilai Keputusan</span></a>
          <ul class="dropdown-menu">
